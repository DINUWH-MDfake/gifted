...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~S75niTTQ#qmRmt1JZeyz8llWHT9BCQnCDZ9ucmHi4Z3LA3JrkR8k", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
MODE: process.env.MODE || "privet", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "94728899640", // Only 1 owner Number Here, others Add to sudo numbers...
...
BAD_WORDS: process.env.BAD_WORDS || "fuck, pussy, anus, idiot,huththo,cariyo", // Add Yours Separated by Comma(will be deleted if ANTIBAD is set to true)
...
TIME_ZONE: process.env.TIME_ZONE || "Sri-Lanka/Colombo", // Enter yours else leave blank if not sure
};
